...
# Heat equation function for SciPy
...
# Solve using your classical linear PDE solver
...
# Solve using your quantum linear PDE solver
...
# Plot your classical solver solution
for i in range(0, nt + 1, nt // 10):
    axs[1].plot(x, your_solution[i, :], '--', label=f'Your Solver t={sol.t[i]:.2f}')

# Plot quantum solver solution
for i in range(0, nt + 1, nt // 10):
